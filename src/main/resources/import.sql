...
INSERT INTO library.bookdetails  (id, category, created_timestamp, language, name, publication, author_id) VALUES ('1001', 'Novel', current_timestamp, 'Malayalam', 'Manjaveyil maranangal', 'Current books', '304900806036524');
INSERT INTO library.bookdetails  (id, category, created_timestamp, language, name, publication, author_id) VALUES ('1002', 'Novel', current_timestamp, 'Malayalam', 'Kaalam', 'Current books', '304892962153036');
INSERT INTO library.bookdetails  (id, category, created_timestamp, language, name, publication, author_id) VALUES ('1003', 'Novel', current_timestamp, 'Malayalam', 'Randamoozham', 'Current books', '304892962153036');
...
INSERT INTO library.book (id, contributed_by, created_timestamp, price, rack, status, updated_timestamp, book_details_id, purchased_date) VALUES ('6456', 'ghi', current_timestamp, 300, 'Rack 3', 'available', current_timestamp, 1002, current_timestamp);
